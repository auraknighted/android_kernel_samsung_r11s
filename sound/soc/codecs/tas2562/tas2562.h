...
TAS2562_INTERRUPTCONFIGURATION_PININTCONFIG10_ASSERT2MSONLATCHEDINTERRUPTS \
	(0x3 << 0)
#define TAS2562_CLOCK_HALT_TIMER_MASK	(0x7 << 3)
#define TAS2562_CLOCK_HALT_1MS		(0x0 << 3)
#define TAS2562_CLOCK_HALT_3MS		(0x1 << 3)
#define TAS2562_CLOCK_HALT_26MS		(0x2 << 3)
#define TAS2562_CLOCK_HALT_52MS		(0x3 << 3)
#define TAS2562_CLOCK_HALT_104MS	(0x4 << 3)
#define TAS2562_CLOCK_HALT_209MS	(0x5 << 3)
#define TAS2562_CLOCK_HALT_419MS	(0x6 << 3)
#define TAS2562_CLOCK_HALT_838MS	(0x7 << 3)
...
#define ERROR_CLOCK		0x0000001
#define ERROR_YRAM_CRCCHK	0x0000002
#define ERROR_OVER_CURRENT	0x0000004
#define ERROR_DIE_OVERTEMP	0x0000008
#define ERROR_OVER_VOLTAGE	0x0000010
#define ERROR_UNDER_VOLTAGE	0x0000020
#define ERROR_BROWNOUT		0x0000040
#define ERROR_CLASSD_PWR	0x0000080
