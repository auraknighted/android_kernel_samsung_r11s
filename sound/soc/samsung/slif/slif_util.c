...
void __iomem *slif_devm_get_ioremap(struct platform_device *pdev,
...
void __iomem *slif_devm_get_request_ioremap(struct platform_device *pdev,
		const char *name, phys_addr_t *phys_addr, size_t *size)
{
	struct resource *res;
	void __iomem *ret;
...
struct clk *slif_devm_clk_get_and_prepare(struct platform_device *pdev,
		const char *name)
{
...
int slif_of_samsung_property_read_u32(struct device *dev,
...
int slif_of_samsung_property_read_u32_array(struct device *dev,
		const struct device_node *np,
...
int slif_of_samsung_property_read_string(struct device *dev,
		const struct device_node *np,
