/* sound/soc/samsung/vts/slif_util.h
 *
...
#ifndef __SND_SOC_SLIF_UTIL_H
#define __SND_SOC_SLIF_UTIL_H
 ...
 */
extern void __iomem *slif_devm_get_ioremap(struct platform_device *pdev,
 ...
 * @return	virtual address
 */
extern void __iomem *slif_devm_get_request_ioremap(struct platform_device *pdev,
		const char *name, phys_addr_t *phys_addr, size_t *size);
 ...
 */
extern struct clk *slif_devm_clk_get_and_prepare(struct platform_device *pdev,
		const char *name);
 ...
 * @return	error code
 */
extern int slif_of_samsung_property_read_u32(struct device *dev,
 ...
 * @return	error code
 */
extern int slif_of_samsung_property_read_u32_array(struct device *dev,
		const struct device_node *np,
 ...
 * @return	error code
 */
extern int slif_of_samsung_property_read_string(struct device *dev,
		const struct device_node *np,
		const char *propname, const char **out_string);
#endif /* __SND_SOC_SLIF_UTIL_H */
