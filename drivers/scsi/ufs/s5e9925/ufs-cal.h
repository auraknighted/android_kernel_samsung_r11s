...
static struct ufs_cal_phy_cfg init_cfg_evt0[] = {
	...
	{0x0000, 0x014, 0x29, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x064, 0x34, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x11C, 0x14, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	...
	{0x0000, 0xBB8, 0x13, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0xA24, 0x60, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},

	{0x0000, 0x8CC, 0x15, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x8D0, 0x30, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x8D4, 0x77, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x8D8, 0x77, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x8DC, 0x05, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x8E0, 0x61, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x8E4, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x8E8, 0x40, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x8EC, 0x77, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x8F0, 0xFF, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x8F4, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x8F8, 0x40, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x8FC, 0x1B, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x900, 0x1B, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x904, 0x1B, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x908, 0x6C, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	...
	{0x0000, 0x960, 0x22, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x964, 0x28, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x968, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x96C, 0x07, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x970, 0x3F, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x974, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x978, 0x02, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x97C, 0x22, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x980, 0x50, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x98C, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x990, 0x01, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x994, 0x22, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x998, 0x50, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},

	{0x0000, 0xAAC, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0xAB0, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},

	{0x0000, 0xABC, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0xAC0, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},

	{0x0000, 0xAC4, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0xAC8, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0xACC, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0xAD0, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
...
static struct ufs_cal_phy_cfg init_cfg_evt1[] = {
	...
	{0x0000, 0x00C, 0x34, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x014, 0x31, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x01C, 0x3E, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	...
	{0x0000, 0x064, 0x34, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x074, 0x00, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x11C, 0x04, PMD_ALL, PHY_PMA_COMN, BRD_ALL},

	{0x0000, 0x150, 0x88, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x19C, 0x4C, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x1A0, 0x4C, PMD_ALL, PHY_PMA_COMN, BRD_ALL},

	{0x0000, 0x114, 0x20, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x118, 0x00, PMD_ALL, PHY_PMA_COMN, BRD_ALL},

	{0x0000, 0x804, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x808, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x80C, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	...
	{0x0000, 0xA04, 0x48, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0xA20, 0xFA, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0xA24, 0x60, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0xBB8, 0x03, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
...
static struct ufs_cal_phy_cfg post_ah8_cfg_evt0[] = {
	...
	{0x0000, 0x520, 0x130014, PMD_HS, HCI_AH8_CMN, BRD_ALL},

	// need to lane# check
	{0x0000, 0x610, 0x000009F4, PMD_HS, HCI_AH8_TRSV, BRD_ALL},
	{0x0000, 0x650, 0x00000008, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x614, 0x00000A00, PMD_HS, HCI_AH8_TRSV, BRD_ALL},
	{0x0000, 0x654, 0x0000003A, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x618, 0x00000B64, PMD_HS, HCI_AH8_TRSV, BRD_ALL},
	{0x0000, 0x658, 0x00000030, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x61C, 0x00000B64, PMD_HS, HCI_AH8_TRSV, BRD_ALL},
	{0x0000, 0x65C, 0x00000033, PMD_HS, HCI_AH8_CMN, BRD_ALL},

	{0x0000, 0x690, 0x401E0000, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x6D0, 0x00000000, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x694, 0x000009F4, PMD_HS, HCI_AH8_TRSV, BRD_ALL},
	{0x0000, 0x6D4, 0x00000000, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x698, 0x00000A00, PMD_HS, HCI_AH8_TRSV, BRD_ALL},
	{0x0000, 0x6D8, 0x00000030, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x69C, 0x00000B64, PMD_HS, HCI_AH8_TRSV, BRD_ALL},
	{0x0000, 0x6DC, 0x00000032, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x6A0, 0x00000B64, PMD_HS, HCI_AH8_TRSV, BRD_ALL},
	{0x0000, 0x6E0, 0x00000022, PMD_HS, HCI_AH8_CMN, BRD_ALL},
...
static struct ufs_cal_phy_cfg post_ah8_cfg_evt1[] = {
	...
	{0x0000, 0x614, 0x00000A00, PMD_HS, HCI_AH8_TRSV, BRD_ALL},
	{0x0000, 0x654, 0x0000003A, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x618, 0x00000000, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x658, 0x00000051, PMD_HS, HCI_AH8_CMN, BRD_ALL},

	{0x0000, 0x690, 0x00000000, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x6D0, 0x00000011, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x694, 0x401E0000, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x6D4, 0x00000000, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x698, 0x000009F4, PMD_HS, HCI_AH8_TRSV, BRD_ALL},
	{0x0000, 0x6D8, 0x00000000, PMD_HS, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x69C, 0x00000A00, PMD_HS, HCI_AH8_TRSV, BRD_ALL},
	{0x0000, 0x6DC, 0x00000030, PMD_HS, HCI_AH8_CMN, BRD_ALL},
