...
static void npu_device_sysevent_notif_register_notifier(void)
{
...
;
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 4, 0)	/* TODO : Move wrapper */
...
static int __init npu_device_init(void)
{
	...
	npu_device_sysevent_notif_register_notifier();
