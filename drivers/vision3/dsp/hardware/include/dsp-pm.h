...
typedef int (*pm_handler_t)(struct dsp_pm *, int, int);
...
struct dsp_pm_ops {
	...
	int (*update_freq_info)(struct dsp_pm *pm, int id);
	...
	int (*probe)(struct dsp_pm *pm, void *sys);
