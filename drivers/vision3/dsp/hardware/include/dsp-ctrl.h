...
struct dsp_ctrl_ops {
	...
	unsigned int (*sm_readl)(struct dsp_ctrl *ctrl, unsigned int addr);
	int (*sm_writel)(struct dsp_ctrl *ctrl, unsigned int addr, int val);
	unsigned int (*dhcp_readl)(struct dsp_ctrl *ctrl, unsigned int addr);
	int (*dhcp_writel)(struct dsp_ctrl *ctrl, unsigned int addr, int val);
	unsigned int (*secure_readl)(struct dsp_ctrl *ctrl, unsigned int addr);
	int (*secure_writel)(struct dsp_ctrl *ctrl, unsigned int addr, int val);
	...
	int (*probe)(struct dsp_ctrl *ctrl, void *sys);
