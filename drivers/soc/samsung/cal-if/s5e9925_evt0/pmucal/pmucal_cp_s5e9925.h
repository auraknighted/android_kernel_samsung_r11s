...
struct pmucal_seq cp_reset_assert[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_DELAY, "delay", 0, 0, 0, 0x3e8, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CP_INT_EN", 0x15860000, 0x3944, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CP_INT_EN", 0x15860000, 0x3944, (0x1 << 5), (0x0 << 5), 0, 0, 0xffffffff, 0),
...
struct pmucal_seq cp_reset_release[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CP_INT_EN", 0x15860000, 0x3944, (0x1 << 5), (0x1 << 5), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WAIT, "CP_IN", 0x15860000, 0x3924, (0x1 << 4), (0x1 << 4), 0, 0, 0xffffffff, 0),
};
