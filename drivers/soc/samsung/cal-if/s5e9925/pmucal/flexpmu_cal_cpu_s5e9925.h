...
struct pmucal_seq core00_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL0_HCHGEN_CLKMUX_CORE", 0x1d040000, 0x0860, (0x1 << 5), (0x1 << 5), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster0_cpu_up", 0, 0, 0x21, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL0_HCHGEN_CLKMUX_CORE", 0x1d040000, 0x0860, (0x1 << 5), (0x0 << 5), 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core10_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL1_HCHGEN_CLKMUX_CORE", 0x1d050000, 0x0860, (0x1 << 5), (0x1 << 5), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster1_cpu_up", 0, 0, 0x31, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL1_HCHGEN_CLKMUX_CORE", 0x1d050000, 0x0860, (0x1 << 5), (0x0 << 5), 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core20_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL2_HCHGEN_CLKMUX_CORE", 0x1d060000, 0x0860, (0x1 << 5), (0x1 << 5), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster2_cpu_up", 0, 0, 0x41, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL2_HCHGEN_CLKMUX_CORE", 0x1d060000, 0x0860, (0x1 << 5), (0x0 << 5), 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq cluster0_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "DSU_HCHGEN_CLKMUX_CLUSTER", 0x1d030000, 0x0860, (0x1 << 5), (0x1 << 5), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster0_noncpu_up", 0, 0, 0x28, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "DSU_HCHGEN_CLKMUX_CLUSTER", 0x1d030000, 0x0860, (0x1 << 5), (0x0 << 5), 0, 0, 0xffffffff, 0),
...
struct pmucal_seq cluster1_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "dd_dump_config", 0x1d120000, 0x0700, (0x1 << 0), (0x1 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "dd_dump_config", 0x1d128000, 0x0700, (0x1 << 0), (0x1 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "dd_dump_config", 0x1d124000, 0x0700, (0x1 << 0), (0x1 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "GLOBALTHROTTEN", 0x1d090000, 0x0200, (0x1 << 31), (0x1 << 31), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "GLOBALTHROTTEN", 0x1d140000, 0x0200, (0x1 << 31), (0x1 << 31), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "GLOBALTHROTTEN", 0x1d150000, 0x0200, (0x1 << 31), (0x1 << 31), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "GLOBALTHROTTEN", 0x1d090000, 0x0200, (0xffffffff << 0), (0xca << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "GLOBALTHROTTEN", 0x1d140000, 0x0200, (0xffffffff << 0), (0xca << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "GLOBALTHROTTEN", 0x1d150000, 0x0200, (0xffffffff << 0), (0xca << 0), 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq cluster2_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "dd_dump_config", 0x1d12c000, 0x0700, (0x1 << 0), (0x1 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "GLOBALTHROTTEN", 0x1d0a0000, 0x0200, (0x1 << 31), (0x1 << 31), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "GLOBALTHROTTEN", 0x1d0a0000, 0x0200, (0xffffffff << 0), (0xca << 0), 0, 0, 0xffffffff, 0),
};
