...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU4_INT_EN", 0x11860000, 0x1244, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU4_INT_EN", 0x11860000, 0x1244, (0x1 << 3), (0x1 << 3), 0, 0, 0xffffffff, 0),
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU5_INT_EN", 0x11860000, 0x12c4, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU5_INT_EN", 0x11860000, 0x12c4, (0x1 << 3), (0x1 << 3), 0, 0, 0xffffffff, 0),
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPU0_INT_EN", 0x11860000, 0x1544, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPU0_INT_EN", 0x11860000, 0x1544, (0x1 << 3), (0x1 << 3), 0, 0, 0xffffffff, 0),
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPU1_INT_EN", 0x11860000, 0x15c4, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPU1_INT_EN", 0x11860000, 0x15c4, (0x1 << 3), (0x1 << 3), 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core00_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL0_HCHGEN_CLKMUX_CPU", 0x10820000, 0x0844, (0x1 << 5), (0x1 << 5), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster0_cpu_up", 0, 0, 0x21, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL0_HCHGEN_CLKMUX_CPU", 0x10820000, 0x0844, (0x1 << 5), (0x0 << 5), 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core10_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL1_HCHGEN_CLKMUX_CPU", 0x10830000, 0x0844, (0x1 << 5), (0x1 << 5), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster1_cpu_up", 0, 0, 0x31, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL1_HCHGEN_CLKMUX_CPU", 0x10830000, 0x0844, (0x1 << 5), (0x0 << 5), 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq cluster0_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "DSU_HCHGEN_CLKMUX_DSU", 0x108a0000, 0x0860, (0x1 << 5), (0x1 << 5), 0, 0, 0xffffffff, 0),
