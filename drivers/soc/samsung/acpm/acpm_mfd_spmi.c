...
int exynos_acpm_read_reg(struct device_node *acpm_mfd_node, u8 sid, u16 type, u8 reg, u8 *dest)
{
...
int exynos_acpm_bulk_read(struct device_node *acpm_mfd_node, u8 sid, u16 type, u8 reg, int count, u8 *buf)
{
	unsigned int channel_num, size;
	struct ipc_config config;
	unsigned int command[4] = {0,};
...
int exynos_acpm_write_reg(struct device_node *acpm_mfd_node, u8 sid, u16 type, u8 reg, u8 value)
{
	unsigned int channel_num, size;
	struct ipc_config config;
	unsigned int command[4] = {0,};
...
int exynos_acpm_bulk_write(struct device_node *acpm_mfd_node, u8 sid, u16 type, u8 reg, int count, u8 *buf)
{
	unsigned int channel_num, size;
	struct ipc_config config;
	unsigned int command[4] = {0,};
...
int exynos_acpm_update_reg(struct device_node *acpm_mfd_node, u8 sid, u16 type, u8 reg, u8 value, u8 mask)
{
	unsigned int channel_num, size;
	struct ipc_config config;
	unsigned int command[4] = {0,};
