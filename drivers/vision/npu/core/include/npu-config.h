...
#ifdef CONFIG_DSP_USE_VS4L
#define TMP_DSP_WAIT_MODE			DSP_SYSTEM_WAIT_MODE_INTERRUPT
#define TMP_DSP_WAIT_RESET			1000
#define TMP_DSP_WAIT_BOOT			3000
#endif
#ifdef CONFIG_NPU_USE_LLC
#define TMP_NPU0_LLC_BOOST_BUFFER_SIZE		8
#define TMP_NPU1_LLC_BOOST_BUFFER_SIZE		0
#define TMP_NPU2_LLC_BOOST_BUFFER_SIZE		0
#define TMP_NPU_LLC_CHUNK_SIZE			(512 * K_SIZE)
#endif
#ifdef CONFIG_NPU_IMB_THRESHOLD
#define	TMP_NPU_IMB_THRESHOLD_SIZE		(0x40000000)
#endif
#endif
