...
#define AMS_SAMPLING_TIME					(976)  /* usec */
...
/* FFT_1024 */
//#define AMS_FLICKER_NUM_SAMPLES         (4096)
//#define AMS_CLR_WIDE_FLICKER_NUM_SAMPLES (1024)

/* FFT_512 */
#define AMS_FLICKER_NUM_SAMPLES         (1024)
#define AMS_CLR_WIDE_FLICKER_NUM_SAMPLES (256) // Clear & wide = 128 samples ,  128 * 2byte * 2ch = 512byte

#define AMS_FLICKER_THR_LVL                   (270)
//#define AMS_FLICKER_THR_LVL                   (128)

#define AMS_FFT_SIZE FFT_256
//#define AMS_FFT_SIZE FFT_1024
...
typedef struct _amsAlsContext {
	...
	uint32_t step0_mod0_gain0;
	uint32_t step0_mod0_gain1;
...
typedef enum _2510_regMasks {
	...
	MASK_MEASUREMENT_SEQUENCER_FILL_GAPS = 0x40, /* register 0xA2 */
