...
#define SYSMMU_MAX_VID			(3)

#define SYSMMU_PANIC_BY_DEV		(3)

enum pcie_sysmmu_vid {
	PCIE_SYSMMU_NOT_USED, /* For UFS */
	PCIE_SYSMMU_VID_GEN2,
	PCIE_SYSMMU_VID_GEN3,
};

#define SYSMMU_PCIE_VID_OFFSET		(PCIE_SYSMMU_VID_GEN2 - PCIE_SYSMMU_NOT_USED)
