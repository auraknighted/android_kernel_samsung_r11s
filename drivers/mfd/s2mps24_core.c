			     ...
			     const struct i2c_device_id *dev_id)
{
	...
	s2mps24->pmic = pmic_i2c_new_dummy(i2c->adapter, I2C_ADDR_PMIC);
	s2mps24->debug_i2c = pmic_i2c_new_dummy(i2c->adapter, I2C_ADDR_DEBUG);
	s2mps24->adc_i2c = pmic_i2c_new_dummy(i2c->adapter, I2C_ADDR_ADC);
