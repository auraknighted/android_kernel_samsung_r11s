...
#define M_RESETN_M1_MASK			(0x1 << 1) // Invalid for Papaya
...
#define VERSION_INFO					0x02070000
...
#define DSIM_FH_COMPENSATE				(0x01E4)
#define DSIM_FH_COMPENSATE_LAST_LINE_COMPENSATE(_x)	((_x) << 12)
#define DSIM_FH_COMPENSATE_LAST_LINE_COMPENSATE_EN_MASK	(0x1 << 8)
#define DSIM_FH_COMPENSATE_FH_START_POINT(_x)		((_x) << 0)

#define DSIM_TRANS_MODE					(0x0200)
...
/*TBD: Bit fields are needs to be added */
...
/* ANA_CON2 */
#define DSIM_PHY_HSVREG_AMP_ICON(_x)		(((_x) & 0x3) << 0)
#define DSIM_PHY_HSVREG_AMP_ICON_MASK		(0x3 << 0)
