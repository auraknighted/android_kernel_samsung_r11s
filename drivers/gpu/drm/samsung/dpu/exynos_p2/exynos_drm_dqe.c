...
pr_info("%s[%d]: "fmt, DQE_DRIVER_NAME, dqe->id, ##__VA_ARGS__)

#define dqe_warn(dqe, fmt, ...)	\
pr_warn("%s[%d]: "fmt, DQE_DRIVER_NAME, dqe->id, ##__VA_ARGS__)

#define dqe_err(dqe, fmt, ...)	\
pr_err("%s[%d]: "fmt, DQE_DRIVER_NAME, dqe->id, ##__VA_ARGS__)

#define dqe_debug(dqe, fmt, ...)	\
pr_debug("%s[%d]: "fmt, DQE_DRIVER_NAME, dqe->id, ##__VA_ARGS__)
