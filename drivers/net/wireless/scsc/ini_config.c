...
static void log_failed_psids(struct slsi_dev *sdev, u8 *mib_buffer, unsigned int mib_buffer_len)
{
	...
	while (offset < mib_buffer_len) {
		...
		SLSI_ERR(sdev, "%d ", (int)(decoded_mib_value.psid));
	}
...
static int encode_uint_mib(struct slsi_dev *sdev, u8 *buf, u16 *pos, u8 *value, struct ini_lookup *lookup_entry)
{
	...
	if (slsi_mib_encode_uint(&mib_data, lookup_entry->psid, value_int, index) != SLSI_MIB_STATUS_SUCCESS) {
...
struct ini_lookup slsi_ini_config_lookup_table[] = {
	{.key = "RoamCommon_MinRoamDetla", .func_p = encode_uint_mib, .psid = 2322, .index = -1, .unit_con_factor = 100},
	{.key = "RoamCommon_Delta", .func_p = encode_uint_mib, .psid = 2302, .index = -1, .unit_con_factor = 1},
	{.key = "RoamScan_FirstTimer", .func_p = encode_uint_mib, .psid = 2058, .index = -1, .unit_con_factor = 1000000},
	{.key = "RoamScan_SecondTimer", .func_p = encode_uint_mib, .psid = 2052, .index = -1, .unit_con_factor = 1000000},
	{.key = "RoamScan_InactiveTimer", .func_p = encode_uint_mib, .psid = 2059, .index = -1, .unit_con_factor = 1},
	{.key = "RoamScan_InactiveCount", .func_p = encode_uint_mib, .psid = 2319, .index = -1, .unit_con_factor = 1},
	{.key = "RoamScan_StepRSSI", .func_p = encode_uint_mib, .psid = 2062, .index = -1, .unit_con_factor = 1},
	{.key = "RoamRSSI_Trigger", .func_p = encode_uint_mib, .psid = 2050, .index = -1, .unit_con_factor = 1},
	{.key = "RoamCU_Trigger", .func_p = encode_mib_roamcu_trig, .psid = 2308, .index = 1, .unit_con_factor = 1},
	{.key = "RoamCU_MonitorTime", .func_p = encode_uint_mib, .psid = 2311, .index = -1, .unit_con_factor = 1},
	{.key = "RoamCU_24GRSSIRange", .func_p = encode_uint_mib, .psid = 2307, .index = 1, .unit_con_factor = 1},
	{.key = "RoamCU_5GRSSIRange", .func_p = encode_uint_mib, .psid = 2307, .index = 2, .unit_con_factor = 1},
	{.key = "Roaming_TriggerBand", .func_p = encode_uint_mib, .psid = 2073, .index = -1, .unit_con_factor = 1},
	{.key = "RoamIdle_InactiveTime", .func_p = encode_uint_mib, .psid = 2066, .index = -1, .unit_con_factor = 1},
	{.key = "RoamIdle_MinRSSI", .func_p = encode_uint_mib, .psid = 2064, .index = -1, .unit_con_factor = 1},
	{.key = "RoamIdle_RSSIVariation", .func_p = encode_uint_mib, .psid = 2063, .index = -1, .unit_con_factor = 1},
	{.key = "RoamIdle_InactivePacketCount", .func_p = encode_uint_mib, .psid = 2071, .index = -1, .unit_con_factor = 1},
	{.key = "RoamIdle_Delta", .func_p = encode_uint_mib, .psid = 2074, .index = -1, .unit_con_factor = 1},
	{.key = "RoamBeaconLoss_TargetMinRSSI", .func_p = encode_uint_mib, .psid = 2299, .index = -1, .unit_con_factor = 1},
	{.key = "RoamEmergency_TargetMinRSSI", .func_p = encode_uint_mib, .psid = 2301, .index = -1, .unit_con_factor = 1},
	{.key = "RoamBTM_Delta", .func_p = encode_uint_mib, .psid = 2304, .index = -1, .unit_con_factor = 1},
	{.key = "RoamAPScore_RSSIWeight", .func_p = encode_uint_mib, .psid = 2305, .index = -1, .unit_con_factor = 1},
	{.key = "RoamAPScore_CUWeight", .func_p = encode_uint_mib, .psid = 2303, .index = -1, .unit_con_factor = 1},
	{.key = "RoamAPScore_Band1_RSSIFactorValue1", .func_p = encode_mib_band1_rssi_factor_value1, .psid = 2306,
	 .index = 1, .unit_con_factor = 1},
	...
	{.key = "RoamAPScore_Band2_RSSIFactorScore5", .func_p = encode_mib_band2_rssi_factor_score5, .psid = 2306,
	 .index = 2, .unit_con_factor = 1},
	{.key = "RoamNCHO_Trigger", .func_p = encode_uint_mib, .psid = 2092, .index = -1, .unit_con_factor = 1},
	{.key = "RoamNCHO_Delta", .func_p = encode_uint_mib, .psid = 2075, .index = -1, .unit_con_factor = 1},
	{.key = "RoamNCHO_FullScanPeriod", .func_p = encode_uint_mib, .psid = 2053,
	 .index = -1, .unit_con_factor = 1000000},
	...
	{.key = "RoamNCHO_PassiveCH_DwellTime", .func_p = encode_uint_mib, .psid = 2644,
	 .index = -1, .unit_con_factor = 1},
	{.key = "RoamNCHO_HomeTime", .func_p = encode_uint_mib, .psid = 2069, .index = -1, .unit_con_factor = 1},
	{.key = "RoamNCHO_AwayTime", .func_p = encode_uint_mib, .psid = 2070, .index = -1, .unit_con_factor = 1},
	...
	{.key = "ConDTIMSkipping_Number", .func_p = encode_mib_con_dtim_skipping_number, .psid = 2518,
	 .index = -1, .unit_con_factor = 1},
	{.key = "ConKeepAlive_Interval", .func_p = encode_uint_mib, .psid = 2502, .index = -1, .unit_con_factor = 1},
	{.key = "RoamWTC_ScanMode", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamWTC_HandlingRSSIThreshold", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamWTC_24GCandiRSSIThreshold", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamWTC_5GCandiRSSIThreshold", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamWTC_6GCandiRSSIThreshold", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamBTCoex_ScoreWeight", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamBTCoex_ETPWeight", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamBTCoex_TargetMinRSSI", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamBTCoex_Delta", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamAPScore_Band3_RSSIFactorValue1", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamAPScore_Band3_RSSIFactorValue2", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamAPScore_Band3_RSSIFactorValue3", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamAPScore_Band3_RSSIFactorValue4", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamAPScore_Band3_RSSIFactorScore1", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamAPScore_Band3_RSSIFactorScore2", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamAPScore_Band3_RSSIFactorScore3", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamAPScore_Band3_RSSIFactorScore4", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamScan_6G_PSC_DwellTime", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "RoamScan_6G_NonPSC_DwellTime", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "ConBeaconLoss_TimeoutOnSleep", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0},
	{.key = "ConDTIMSkipping_MaxTime", .func_p = NULL, .psid = -100, .index = -1, .unit_con_factor = 0}
};
...
static int slsi_parse_ini_config(struct slsi_dev *sdev, u8 *line, int len)
{
	int ret = 0;
	int index = -1;
	int key_len = 0;
	...
	if ((tmp - line) >= len) {
		SLSI_ERR_NODEV("parsing error/syntax error in ini configuration file\n");
		return -ENOTSUPP;
	}
	...
	index = slsi_ini_config_fn_lookup(key, key_len);
	if (index < 0) {
		SLSI_ERR_NODEV("could not find the parsed key:%.*s in the lookup table\n", key_len, key);
		return -ENOTSUPP;
	}
...
void slsi_read_ini_config_file(struct slsi_dev *sdev)
{
	...
	r = mx140_request_file(sdev->maxwell_core, INI_CONFIG_FILE_PATH, &e);
	if (r != 0) {
		SLSI_ERR(sdev, "Couldn't open %s file r = %d\n", INI_CONFIG_FILE_PATH, r);
		r = mx140_request_file(sdev->maxwell_core, INI_CONFIG_FILE_BACKUP_PATH, &e);
		if (r != 0) {
			SLSI_ERR(sdev, "Couldn't open %s file r = %d\n", INI_CONFIG_FILE_BACKUP_PATH, r);
			return;
		}
	}

	SLSI_INFO(sdev, "Ini conf file opened successfully\n");
	if (!e) {
	...
	while ((tmp - e->data) < e->size) {
		...
		line_len = tmp - line;
		if (line_len > 0) {
			res = slsi_parse_ini_config(sdev, line, line_len);
			if (res)
				SLSI_ERR(sdev, "Error when parsing ini conf file err: %d\n", res);
		}
	...
	set_mibs(sdev);
	if (res)
		SLSI_ERR(sdev, "Err in setting the remaining mibs\n");
