...
#define HIP5_WLAN_TX_DAT_SIZE	0x340000 /* 3.25 MB */
/*** TX POOL - CTL POOL ***/
...
#define HIP5_WLAN_TOTAL_MEM	(HIP5_WLAN_CONFIG_SIZE + HIP5_WLAN_MIB_SIZE + \
				 HIP5_WLAN_TX_SIZE + HIP5_WLAN_RX_SIZE) /* 764 KB + 32 KB + 3328 KB + 512 KB + 64 KB  = 4700KB out of 4762KB */
...
#define HIP5_HIP_ENTRY_HEAD_MAX_NUM_BD            (2)
#define HIP5_HIP_ENTRY_CHAIN_MAX_NUM_BD           (5)
...
#define SLSI_HIP_HIP5_OPT_TX_Q_MAX 16
