...
enum slsi_twt_error_code {
	SLSI_TWT_WIFI_ERROR_NOT_SUPPORTED = -3,
	SLSI_TWT_WIFI_ERROR_NOT_AVAILABLE = -4,
	SLSI_TWT_WIFI_ERROR_INVALID_ARGUMENT = -5,
	SLSI_TWT_WIFI_ERROR_BUSY = -10,
	SLSI_TWT_WIFI_ERROR_TEMPORAL = -99
};
