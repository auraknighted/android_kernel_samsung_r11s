...
void slsi_netif_set_tid_change_tid(struct net_device *dev, struct sk_buff *skb);
...
void slsi_net_downgrade_pri(struct net_device *dev, struct slsi_peer *peer, struct sk_buff *skb);
