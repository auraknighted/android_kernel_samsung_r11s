...
/* Draft P802.11be D1.0 Table 9-50 - TBD */
...
#define DOT11_SC_NSEP_DENIED_O_REASON	152u	/* NSEP priority access denied due to
						 ...
						 * this standard.
						 */
#define DOT11_SC_DENIED_TID_MAP		153u	/* Request denied because the requested
						 * TID-to-Link mapping is unacceptable.
						 */
#define DOT11_SC_PREFER_TID_MAP		154u	/* Preferred TID-to-Link mapping suggested. */
...
/* EHT Action frames - Draft P802.11be D1.0 Sections 9.6.34.1 & 9.6.35.1 - TBD */
#define DOT11_ACTION_CAT_EHT		40u	/* EHT action frame */
#define DOT11_ACTION_CAT_EHTP		41u	/* Protected EHT action frame */
