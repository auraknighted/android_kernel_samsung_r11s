...
struct is_core {
	...
	struct is_video			video_byrp;
	struct is_video			video_rgbp;
	struct is_video			video_mcfp;
	...
	struct is_video			video_orb0;
	struct is_video			video_orb1;
