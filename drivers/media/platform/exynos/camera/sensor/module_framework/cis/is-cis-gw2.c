...
int sensor_gw2_cis_log_status(struct v4l2_subdev *subdev)
{
	...
	sensor_cis_log_status(cis, client, log_gw2,
	...
	const struct i2c_device_id *id)
{
	...
	if (mclk_freq_khz == 19200) {
		if (strcmp(setfile, "default") == 0 ||
			...
			cis->mipi_sensor_mode = sensor_gw2_setfile_A_mipi_sensor_mode_19p2;
			cis->mipi_sensor_mode_size = ARRAY_SIZE(sensor_gw2_setfile_A_mipi_sensor_mode_19p2);
