...
const u32 sensor_4ha_setfile_B_2880x1980_30fps[] = {
	0x0136, 0x1A, 0x1,
	0x0137, 0x00, 0x1,
	0x0301, 0x04, 0x1,
	0x0305, 0x05, 0x1,
...
const u32 sensor_4ha_setfile_B_2640x1980_30fps[] = {
	0x0136, 0x1A, 0x1,
	0x0137, 0x00, 0x1,
	0x0301, 0x04, 0x1,
	0x0305, 0x05, 0x1,
...
const u32 sensor_4ha_setfile_B_2608x1956_30fps[] = {
	0x0136, 0x1A, 0x1,
	0x0137, 0x00, 0x1,
	0x0301, 0x04, 0x1,
	0x0305, 0x05, 0x1,
...
const u32 sensor_4ha_setfile_B_1632x916_30fps[] = {
	0x0136, 0x1A, 0x1,
	0x0137, 0x00, 0x1,
	0x0301, 0x04, 0x1,
	0x0305, 0x05, 0x1,
...
const struct sensor_pll_info_compact sensor_4ha_pllinfo_B_2640x1980_30fps = {
	EXT_CLK_Mhz * 1000 * 1000,	/* ext_clk */
	671000000,			/* mipi_datarate = OPSYCK */
	280800000,			/* VT picxel clk */
	2538,				/* frame_length_lines */
...
const struct sensor_pll_info_compact sensor_4ha_pllinfo_B_2880x1980_30fps = {
	EXT_CLK_Mhz * 1000 * 1000,	/* ext_clk */
	671000000,			/* mipi_datarate = OPSYCK */
	280800000,			/* VT picxel clk */
	2538,				/* frame_length_lines */
...
const struct sensor_pll_info_compact sensor_4ha_pllinfo_B_2608x1956_30fps = {
	EXT_CLK_Mhz * 1000 * 1000,	/* ext_clk */
	671000000,			/* mipi_datarate = OPSYCK */
	280800000,			/* VT picxel clk */
	2538,				/* frame_length_lines */
...
const struct sensor_pll_info_compact sensor_4ha_pllinfo_B_1632x916_30fps = {
	EXT_CLK_Mhz * 1000 * 1000,	/* ext_clk */
	671000000,			/* mipi_datarate = OPSYCK */
	280800000,			/* VT picxel clk */
	2538,				/* frame_length_lines */
...
static const u32 *sensor_4ha_setfiles_B[] = {
	...
	sensor_4ha_setfile_B_2880x1980_30fps,
	sensor_4ha_setfile_B_2640x1980_30fps,
	sensor_4ha_setfile_B_2608x1956_30fps,
	sensor_4ha_setfile_B_1632x1224_30fps,
	sensor_4ha_setfile_B_1632x916_30fps,
...
static const u32 sensor_4ha_setfile_B_sizes[] = {
	...
	sizeof(sensor_4ha_setfile_B_2880x1980_30fps) / sizeof(sensor_4ha_setfile_B_2880x1980_30fps[0]),
	sizeof(sensor_4ha_setfile_B_2640x1980_30fps) / sizeof(sensor_4ha_setfile_B_2640x1980_30fps[0]),
	sizeof(sensor_4ha_setfile_B_2608x1956_30fps) / sizeof(sensor_4ha_setfile_B_2608x1956_30fps[0]),
	sizeof(sensor_4ha_setfile_B_1632x1224_30fps) / sizeof(sensor_4ha_setfile_B_1632x1224_30fps[0]),
	sizeof(sensor_4ha_setfile_B_1632x916_30fps) / sizeof(sensor_4ha_setfile_B_1632x916_30fps[0]),
...
static const struct sensor_pll_info_compact *sensor_4ha_pllinfos_B[] = {
	...
	&sensor_4ha_pllinfo_B_2880x1980_30fps,
	&sensor_4ha_pllinfo_B_2640x1980_30fps,
	&sensor_4ha_pllinfo_B_2608x1956_30fps,
	&sensor_4ha_pllinfo_B_1632x1224_30fps,
	&sensor_4ha_pllinfo_B_1632x916_30fps,
