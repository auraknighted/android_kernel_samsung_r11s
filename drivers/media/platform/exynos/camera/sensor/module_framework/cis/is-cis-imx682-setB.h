 ...
 * [Mode Information]
 *
 * Reference File : IMX682_SEC-CPHY-26MHz_RegisterSetting_ver4.20-4.00_b1_MP_201029_SEC_2.xlsx
 ...
 *    [ 3 ] V2H2_FAE3   : 2x2 Binning mode V2H2 2304x1728 120fps   : FastenAE (4:3)    ,  MIPI lane: 3, MIPI data rate(Mbps/lane): 1358.5
 *    [ 4 ] V2H2_SSL5   : 2x2 Binning mode V2H2 2304x1296 240fps   : SM/SSM (16:9)    ,  MIPI lane: 3, MIPI data rate(Mbps/lane): 1846
 *    [ 5 ] Full_Raw1   : Full_Raw 9248x6936 15fps                 : Single Still Remosaic Capture (4:3)    ,  MIPI lane: 3, MIPI data rate(Mbps/lane): 1995.5
 */
...
const u32 sensor_imx682_setfile_B_2X2BIN_FULL_4624x2604_60FPS[] = {
	/* reg_2Bin_C4 */
	/* 2x2 Binning mode C 4624x2604 @60fps 1885Msps */
	/* H: 4624 */
	/* W: 2604 */
	/* MIPI output setting */
	0x0112, 0x0A, 0x01,
...
const struct sensor_pll_info_compact sensor_imx682_pllinfo_B_2X2BIN_FULL_2000x1128_240FPS = {
	...
	134330000,                  /* pclk = VTPXCK of Clock Information */
	1376,                        /* frame_length_lines */
	2728,                        /* line_length_pck */
};
