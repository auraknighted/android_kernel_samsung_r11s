				...
				u32 dm_index, struct is_ois_hall_data *halldata)
{
	...
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.readTimeStamp = halldata->readTimeStamp;
#ifdef CONFIG_CAMERA_USE_INTERNAL_MCU
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.defaultAngle = halldata->defaultAngle;
#else
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.counter = halldata->counter;
#endif
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.X_AngVel[0] = halldata->X_AngVel[0];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.Y_AngVel[0] = halldata->Y_AngVel[0];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.Z_AngVel[0] = halldata->Z_AngVel[0];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.X_AngVel[1]  = halldata->X_AngVel[1];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.Y_AngVel[1] = halldata->Y_AngVel[1];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.Z_AngVel[1] = halldata->Z_AngVel[1];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.X_AngVel[2]  = halldata->X_AngVel[2];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.Y_AngVel[2] = halldata->Y_AngVel[2];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.Z_AngVel[2] = halldata->Z_AngVel[2];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.X_AngVel[3]  = halldata->X_AngVel[3];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.Y_AngVel[3] = halldata->Y_AngVel[3];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.Z_AngVel[3] = halldata->Z_AngVel[3];
#ifdef CONFIG_CAMERA_USE_INTERNAL_MCU
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.X_Angle[0] = halldata->X_Angle[0];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.Y_Angle[0] = halldata->Y_Angle[0];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.X_Angle[1] = halldata->X_Angle[1];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.Y_Angle[1] = halldata->Y_Angle[1];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.X_Angle[2] = halldata->X_Angle[2];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.Y_Angle[2] = halldata->Y_Angle[2];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.X_Angle[3] = halldata->X_Angle[3];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.Y_Angle[3] = halldata->Y_Angle[3];
	sensor_peri->cis.expecting_aa_dm[dm_index].vendor_oisHallData.index = halldata->index;
#endif
