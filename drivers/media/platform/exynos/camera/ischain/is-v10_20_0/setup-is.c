...
static void exynos8825_is_print_clk_reg(void)
{

}

static int exynos8825_is_print_clk(struct device *dev)
{
...
int exynos8825_is_clk_gate(u32 clk_gate_id, bool is_on)
{
	return 0;
}

int exynos8825_is_uart_gate(struct device *dev, bool mask)
{
	return 0;
}

int exynos8825_is_get_clk(struct device *dev)
{
	struct clk *clk;
	size_t i;
...
int exynos8825_is_cfg_clk(struct device *dev)
{
	return 0;
}

int exynos8825_is_clk_on(struct device *dev)
{
	int ret = 0;
...
int exynos8825_is_clk_off(struct device *dev)
{
	int ret = 0;
	struct exynos_platform_is *pdata;
 ...
 */
int exynos8825_is_clk_get_rate(struct device *dev)
{
	size_t index;
...
{
	exynos8825_is_clk_gate(clk_gate_id, is_on);
	return 0;
}
