...
#define IS_DVFS_SENSOR_POSITION_TELE 4
#define IS_DVFS_SENSOR_POSITION_ULTRAWIDE 2
#define IS_DVFS_SENSOR_POSITION_ULTRATELE 6
...
#define IS_DVFS_SENSOR_MODE_TELE_FASTAE -1
#define IS_DVFS_SENSOR_MODE_TELE_REMOSAIC -1
...
#define IS_DVFS_SENSOR_MODE_FRONT_FASTAE -1
...
enum IS_DVFS_SENSOR {
	...
	IS_DVFS_SENSOR_ULTRATELE,
	IS_DVFS_SENSOR_WIDE_TELE,
	IS_DVFS_SENSOR_WIDE_ULTRAWIDE,
	IS_DVFS_SENSOR_WIDE_MACRO,
	IS_DVFS_SENSOR_TELE_ULTRAWIDE,
	IS_DVFS_SENSOR_TELE_ULTRATELE,
	IS_DVFS_SENSOR_ULTRAWIDE_ULTRATELE,
	IS_DVFS_SENSOR_WIDE_ULTRATELE,
