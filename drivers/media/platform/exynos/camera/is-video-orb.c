...
int is_orb0_video_probe(void *data)
{
	int ret = 0;
	struct is_core *core;
...
int is_orb1_video_probe(void *data)
{
	int ret = 0;
	struct is_core *core;
	struct is_video *video;
