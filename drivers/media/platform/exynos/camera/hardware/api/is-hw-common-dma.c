...
int is_hw_dma_set_msb_align(struct is_common_dma *dma, u32 msb_align)
{
	void __iomem *base = __is_hw_dma_get_base_addr(dma);
...
KUNIT_EXPORT_SYMBOL(is_hw_dma_set_ops);
...
KUNIT_EXPORT_SYMBOL(is_hw_dma_get_rgb_format);
...
KUNIT_EXPORT_SYMBOL(is_hw_dma_get_yuv_format);
...
int is_hw_dma_get_header_stride(u32 width, u32 block_width, u32 align)
{
	u32 header_stride = 0;
