...
enum aa_capture_intent {
	...
	AA_CAPTURE_INTENT_STILL_CAPTURE_RCC_DYNAMIC_SHOT                        = 123,  /* Not used, Will be removed */
	AA_CAPTURE_INTENT_STILL_CAPTURE_HIGHRES_SINGLE_FLASH                    = 124,
	AA_CAPTURE_INTENT_STILL_CAPTURE_RCC_SINGLE                              = 125,  /* Not used, Will be removed */
	AA_CAPTURE_INTENT_STILL_CAPTURE_SHORT_REF_LLHDR_DYNAMIC_SHOT            = 126,
	AA_CAPTURE_INTENT_STILL_CAPTURE_PROCESSED_HIGHRES_SINGLE                = 127,  /* Not used, Will be removed */
	AA_CAPTURE_INTENT_STILL_CAPTURE_PROCESSED_HIGHRES_DYNAMIC_SHOT          = 128,  /* Not used, Will be removed */
	AA_CAPTURE_INTENT_STILL_CAPTURE_PROCESSED_HIGHRES_MFHDR_DYNAMIC_SHOT    = 129,  /* Not used, Will be removed */
	AA_CAPTURE_INTENT_STILL_CAPTURE_PROCESSED_HIGHRES_SINGLE_FLASH          = 130,  /* Not used, Will be removed */
