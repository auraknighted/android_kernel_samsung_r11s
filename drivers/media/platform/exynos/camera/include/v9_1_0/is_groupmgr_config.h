...
#define GROUP_ID_BYRP           (GROUP_ID_MAX + 1)
#define GROUP_ID_RGBP           (GROUP_ID_MAX + 2)
#define GROUP_ID_MCFP           (GROUP_ID_MAX + 3)
#define GROUP_ID_YUVP           (GROUP_ID_MAX + 4)
#define GROUP_ID_ORB0			(GROUP_ID_MAX + 5)
#define GROUP_ID_ORB1			(GROUP_ID_MAX + 6)
...
#define GROUP_ID_PARM_MASK	((1UL << (GROUP_ID_MAX)) - 1)
#define GROUP_ID(id)		(1UL << (id))
