...
struct is_camif_dma_data dma_data;
struct is_camif_wdma_module wdma_mod;

struct is_camif_wdma *test_camif_wdma_get(struct kunit *test, int hint)
{
	int i;
	int flags = 0;
...
void test_camif_wdma_put(struct kunit *test, struct is_camif_wdma *wdma)
{
	int i;
