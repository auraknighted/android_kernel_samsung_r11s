...
write_complete_retry:
	...
	pr_info("CBLog: read_command_complete_check = %d\n", read_command_complete_check);
...
crc_retry:
	...
	is_sec_i2c_read_otp_4ha(client, buf, S5K4HA_OTP_START_ADDR, S5K4HA_OTP_USED_CAL_SIZE);
	...
	if (unlikely(ret)) {
		...
		pr_err("%s OTPROM CRC failed for 4HA, retry %d\n", __func__, retry);
	}
	pr_info("%s OTPROM CRC passed for 4HA\n", __func__);
...
i2c_write_retry_global:
	...
	/* OTP Initial Settings */
	is_sensor_addr8_write8(client, 0xfa, 0x10);
	is_sensor_addr8_write8(client, 0xf5, 0xe9);
	is_sensor_addr8_write8(client, 0xfe, 0x02);
	is_sensor_addr8_write8(client, 0x67, 0xc0);
	is_sensor_addr8_write8(client, 0x59, 0x3f);
	is_sensor_addr8_write8(client, 0x55, 0x80);
	is_sensor_addr8_write8(client, 0x65, 0x80);
	is_sensor_addr8_write8(client, 0x66, 0x03);
...
crc_retry:
	/* read cal data */
	info("I2C read cal data\n");
	is_sec_i2c_read_otp_gc5035(client, buf, start_addr, cal_size);
...
i2c_write_retry_global:
	...
	/* OTP Initial Settings */
	is_sensor_addr8_write8(client, 0xfc, 0x01);
	is_sensor_addr8_write8(client, 0xf4, 0x41);
	is_sensor_addr8_write8(client, 0xf5, 0xc0);
	is_sensor_addr8_write8(client, 0xf6, 0x44);
	is_sensor_addr8_write8(client, 0xf8, 0x38);
	is_sensor_addr8_write8(client, 0xf9, 0x82);
	is_sensor_addr8_write8(client, 0xfa, 0x00);
	is_sensor_addr8_write8(client, 0xfd, 0x80);
	is_sensor_addr8_write8(client, 0xfc, 0x81);
	is_sensor_addr8_write8(client, 0xfe, 0x03);
	is_sensor_addr8_write8(client, 0x01, 0x0b);
	is_sensor_addr8_write8(client, 0xf7, 0x01);
	is_sensor_addr8_write8(client, 0xfc, 0x80);
	is_sensor_addr8_write8(client, 0xfc, 0x80);
	is_sensor_addr8_write8(client, 0xfc, 0x80);
	is_sensor_addr8_write8(client, 0xfc, 0x8e);
	is_sensor_addr8_write8(client, 0xfe, 0x00);
	is_sensor_addr8_write8(client, 0x87, 0x09);
	is_sensor_addr8_write8(client, 0xee, 0x72);
	is_sensor_addr8_write8(client, 0xfe, 0x01);
	is_sensor_addr8_write8(client, 0x8c, 0x90);
	is_sensor_addr8_write8(client, 0xf3, 0x30);
	is_sensor_addr8_write8(client, 0xfe, 0x02);

crc_retry:
	/* read cal data */
	info("I2C read cal data\n");
	is_sec_i2c_read_otp_gc02m1(client, buf, GC02M1_OTP_START_ADDR, GC02M1_OTP_USED_CAL_SIZE);
