...
static long is_vender_caminfo_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case CAMINFO_CMD_ID_SET_SENSOR_GLOBAL_TEST:
		ret = is_vender_test_sensor_cmd_set_sensor_global_test(ioctl_cmd.data);
		break;
	case CAMINFO_CMD_ID_GET_SENSOR_GLOBAL_TEST:
		ret = is_vender_test_sensor_cmd_get_sensor_global_test(ioctl_cmd.data);
		break;
	case CAMINFO_CMD_ID_SET_SENSOR_SETFILE_TEST:
		ret = is_vender_test_sensor_cmd_set_sensor_setfile_test(ioctl_cmd.data);
		break;
	case CAMINFO_CMD_ID_GET_SENSOR_SETFILE_TEST:
		ret = is_vender_test_sensor_cmd_get_sensor_setfile_test(ioctl_cmd.data);
		break;
	case CAMINFO_CMD_ID_SET_SENSOR_PLLINFO_TEST:
		ret = is_vender_test_sensor_cmd_set_sensor_pllinfo_test(ioctl_cmd.data);
		break;
	case CAMINFO_CMD_ID_GET_SENSOR_PLLINFO_TEST:
		ret = is_vender_test_sensor_cmd_get_sensor_pllinfo_test(ioctl_cmd.data);
		break;
