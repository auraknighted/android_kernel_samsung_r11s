...
extern int gdc_register_ready_frame_cb(int (*gdc_ready_frame_cb)(unsigned long));
extern void gdc_unregister_ready_frame_cb(void);
extern int gdc_device_run(unsigned long i_ino);
#endif
