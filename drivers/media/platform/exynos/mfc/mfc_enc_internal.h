...
static struct v4l2_queryctrl enc_controls[] = {
	...
	{
		.id = V4L2_CID_MPEG_MFC_HDR10_PLUS_STAT_USER_SHARED_HANDLE,
		.type = V4L2_CTRL_TYPE_INTEGER,
		.name = "HDR10+ statistic info",
		.minimum = INT_MIN,
		.maximum = INT_MAX,
		.step = 1,
		.default_value = 0,
	...
	{
		.id = V4L2_CID_MPEG_MFC_HDR10_PLUS_STAT_ENABLE,
		.type = V4L2_CTRL_TYPE_INTEGER,
		.name = "HDR10+ stat info gen enable",
		.minimum = 0,
		.maximum = 1,
		.step = 1,
		.default_value = 0,
