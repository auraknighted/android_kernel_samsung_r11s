...
typedef enum {
	CCIC_NOTIFY_PD_EVENT_DETACH = 0,
	CCIC_NOTIFY_PD_EVENT_CCIC_ATTACH,
	CCIC_NOTIFY_PD_EVENT_SINK,
	CCIC_NOTIFY_PD_EVENT_SOURCE,
	CCIC_NOTIFY_PD_EVENT_SINK_CAP,
	CCIC_NOTIFY_PD_EVENT_PRSWAP_SNKTOSRC,
} ccic_notifier_pd_event_t;
...
int ccic_notifier_notify(CC_NOTI_TYPEDEF *noti, void *pd,
		int pdic_attach);
int ccic_notifier_register(struct notifier_block *nb,
