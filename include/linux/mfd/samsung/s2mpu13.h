/*
 * s2mpu13.h - Driver for the s2mpu13
 *
...
#ifndef __S2MPU13_MFD_H__
#define __S2MPU13_MFD_H__
#include <linux/platform_device.h>
#include <linux/regmap.h>
#define MFD_DEV_NAME "s2mpu13"
/**
 * sec_regulator_data - regulator data
 * @id: regulator id
 * @initdata: regulator init data (contraints, supplies, ...)
 */
struct s2mpu13_regulator_data {
	int id;
...
struct s2mpu13_platform_data {
	...
	int num_regulators;
	int num_rdata;
	struct	s2mpu13_regulator_data *regulators;
	...
	bool			b1m_afm_warn_en;
	int				b1m_afm_warn_cnt;
	bool			b1m_afm_warn_dvs_mask;
	int				b1m_afm_warn_lv;
