...
struct ASMHCP_PROTOCOL {
	...
	struct ASMHCP_TD_CONTROL /* offset: 0x000010C0 */
	...
	uint8_t reserved[0x20]; /* offset: 0x00002100 */

	/* from driver */
	struct ASMHCP_TD_CONTROL /* offset: 0x00002120 */
		cmd_driver_controller_transfer_ring[ASMHCP_TRANSFER_RING_CMD_SIZE];
	struct ASMHCP_TD_CONTROL /* offset: 0x00003160 */
